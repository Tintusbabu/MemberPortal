...
import com.ibs.lmp.pages.MyFamilyPlanPage;
...
public class MyFamilyPlanTestCase extends ExtentReportUtils {
    /**
    ...
    public void Product_TC_006() throws Exception{
        ...
        MyFamilyPlanPage MyFamilyPlanPage = null;
        try{
            ...
            for(TestData testData: testDataList) {
                if(testCaseName.equals(testData.getTestCaseName())) {
                    ...
                    homePage.selectSubMenu("My Family","My Family Plan");
                    logger = loggerRoot.createNode("My Family Plan");
                    MyFamilyPlanPage myFamilyPlanPage = new MyFamilyPlanPage(driver, logger);
                    myFamilyPlanPage.verifyMyFamilyPlanTitle();

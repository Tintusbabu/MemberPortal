...
import com.ibs.lmp.pages.ForgotPasswordPage;
...
public class ForgotPasswordTestCase extends ExtentReportUtils {
        ...
        try{
            ...
            for(TestData testData: testDataList) {
                if(testCaseName.equals(testData.getTestCaseName())) {
                    ...
                    landingPage.clikOnForgotPasswordLink();
                    logger = loggerRoot.createNode("Forgot Password Page");
                    forgotPasswordPage = new ForgotPasswordPage(driver, logger);
                    forgotPasswordPage.verifyForgotPasswordPageTitle();
                    forgotPasswordPage.enterMembershipNumber(testData);

...
public class MyActivityPage extends CommonUtility {
	 ...
	 */
	public static XPATH LMP_MYACTIVITY_PAGE_VERIFY_MSSG = new XPATH("lmp-myactivity-page-verify-label",readXpathStringFromPropertyFile("XPATH_LMP_MYACTIVITY_PAGE_VERIFY_MSSG"));

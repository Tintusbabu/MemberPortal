...
public class MemberRegistrationPage extends CommonUtility {
	...
	public static XPATH LMP_REGISTRATION_PAGE_ENGLISHLASTNAME_TEXTBOX = new XPATH("lmp-login-page-lastNameInEnglish-textbox",readXpathStringFromPropertyFile("XPATH_LMP_REGISTRATION_PAGE_ENGLISHLASTNAME_TEXTBOX"));
	...
	// RTTYTY
		...
		// Enter FirstNameInKatakana
		clearTextAndEnterValueWithNullCheck(driver, LMP_REGISTRATION_PAGE_KATAKANAFIRSTNAME_TEXTBOX,
				TestDataServices.getTestDataValue(testData, "FirstNameInKatakana"));
	  ...
	  //	selectValueFromDropdownWithNullCheck(driver, LMP_REGISTRATION_PAGE_COUNTRYOFRESIDENCE_DROPDOWN,
		...
		if (registerSuccessMssg) {
			if (!TestDataServices.getTestDataValue(testData, "Validation_MssgRegisterSucess")
				...
				String dataToPrint =  getCurrentDateWithTimeStamp()+" ####  First Name: "+firstName +"  #### Last Name:"+ lastName+"  #### Email ID:"+ email ;
